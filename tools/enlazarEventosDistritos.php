...
foreach($distritos as $distrito)
{
	...
	{
		$punto = geoPHP::load("POINT({$evento['y']} {$evento['x']})","wkt");
		if($poligono->contains($punto))
		{
			$asociados[$evento["idEvento"]]=$distrito;
		}
	}
}
...
{
	mysql_query("UPDATE direcciones SET idDistritoPadre='$distrito' WHERE idEvento='$id'");
